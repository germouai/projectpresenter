...
namespace TPI_ProjectPresenter.Controllers
{
	public class ProjectController : Controller
	{
		public IActionResult ViewProject()
		{
            ...
            projectest.Header = new ProjectEntity.ProjectHeader() { ProjectDescription = "Nos this is the one to make extensive, at least for the testing. You know, maybe it fucks up responsiveness or sth. You can never know until it's fucked up.",
                                                                    ProjectImgRef = "ideas.png", ProjectName = "Testing the project title", ProjectTooltip = "This should be a considerably long text but not so much, it's small and in italicz."  };
